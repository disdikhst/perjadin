                ...
                <table width="100%" cellpadding="4px" style="border-collapse: collapse;">
                    <tbody>
                        <tr>
                            ...
                            <!-- <td colspan="2" style="border: 1px solid black;text-align: left"><?php echo $row->jabatan_ttd ?></td> -->
        ...
        <div class="kanan">
            <table width="100%" style="border-collapse: collapse;font-size:11px">
                <tr>
                    ...
                    <td width="10" style="border-top: 1px solid black">:</td>
                    <td width="137" style="border-right: 1px solid black; border-top: 1px solid black"><?php echo $row->t_berangkat ?></td>
                </tr>
                <tr>
                    ...
                    <td>Ke</td>
                    <td>:</td>
                    <td style="border-right: 1px solid black"><?php echo $row->t_tujuan ?></td>
                </tr>
                <tr>
                    ...
                    <td style="border-right: 1px solid black; border-bottom: 1px solid black"><?php echo tgl_indo(date('Y-m-d', strtotime($row->tgl_berangkat))) ?></td>
                </tr>
                <tr>
                    <td width="109" style="border-top: 1px solid black; border-left: 1px solid black">Tiba di</td>
                    <td width="10" style="border-top: 1px solid black">:</td>
                    <td width="90" style="border-top: 1px solid black; border-right: 1px solid black"><?php echo $row->tibadi1 ?></td>
                    <td width="73" style="border-top: 1px solid black">Berangkat dari</td>
                    <td width="10" style="border-top: 1px solid black">:</td>
                    <td width="137" style="border-right: 1px solid black; border-top: 1px solid black"><?php echo $row->dari1 ?></td>
                </tr>
                <tr>
                    <td height="23" style="border-left: 1px solid black">Pada Tanggal</td>
                    <td>:</td>
                    <td style="border-right: 1px solid black"><?php echo $row->tgl_kiri1 ?></td>
                    <td>Ke</td>
                    <td>:</td>
                    <td style="border-right: 1px solid black"><?php echo $row->ke1 ?></td>
                </tr>
                <tr>
                    <td height="23" style="border-left: 1px solid black">&nbsp;</td>
                    <td>&nbsp;</td>
                    ...
                    <td>Pada Tanggal</td>
                    <td>:</td>
                    <td style="border-right: 1px solid black"><?php echo $row->tgl_kanan1 ?></td>
                </tr>
                <tr>`
                    <td height="50" colspan="3" style="border-left: 1px solid black;border-right: 1px solid black; vertical-align: top;text-align: center;"><?php echo $row->kepalakiri1 ?></td>
                    <td colspan="3" style="vertical-align: top;border-right: 1px solid black;text-align: center;">
                        <p><?php echo $row->kepalakiri1 ?></p>
                    </td>
                </tr>
                <tr>
                    <td height="23" colspan="3" style="border-left: 1px solid black;border-right: 1px solid black;text-align: center;text-decoration: underline;"><?php echo $row->namakiri1 ?></td>
                    <td colspan="3" style="border-right: 1px solid black;text-align: center;text-decoration: underline;"><?php echo $row->namakiri1 ?></td>
                </tr>
                <tr>
                    <td height="23" colspan="3" style="border-bottom: 1px solid black; border-left: 1px solid black;border-right: 1px solid black;text-align: center;"><?php echo $row->nipkiri1 ?></td>
                    <td colspan="3" style="border-bottom: 1px solid black;border-right: 1px solid black;text-align: center;"><?php echo $row->nipkiri1 ?></td>
                </tr>
                <!-- Baris kedua -->
                <tr>
                    <td width="109" style="border-top: 1px solid black; border-left: 1px solid black">Tiba di</td>
                    <td width="10" style="border-top: 1px solid black">:</td>
                    <td width="90" style="border-top: 1px solid black; border-right: 1px solid black"><?php echo $row->tibadi2 ?></td>
                    <td width="73" style="border-top: 1px solid black">Berangkat dari</td>
                    <td width="10" style="border-top: 1px solid black">:</td>
                    <td width="137" style="border-right: 1px solid black; border-top: 1px solid black"><?php echo $row->dari2 ?></td>
                </tr>
                <tr>
                    <td height="23" style="border-left: 1px solid black">Pada Tanggal</td>
                    <td>:</td>
                    <td style="border-right: 1px solid black"><?php echo $row->tgl_kiri2 ?></td>
                    <td>Ke</td>
                    <td>:</td>
                    <td style="border-right: 1px solid black"><?php echo $row->ke2 ?></td>
                </tr>
                <tr>
                    <td height="23" style="border-left: 1px solid black">&nbsp;</td>
                    <td>&nbsp;</td>
                    ...
                    <td>Pada Tanggal</td>
                    <td>:</td>
                    <td style="border-right: 1px solid black"><?php echo $row->tgl_kanan2 ?></td>
                </tr>
                <tr>
                    <td height="50" colspan="3" style="border-left: 1px solid black;border-right: 1px solid black; vertical-align: top;text-align: center;"><?php echo $row->kepalakiri2 ?></td>
                    <td colspan="3" style="vertical-align: top;border-right: 1px solid black;text-align: center;">
                        <p><?php echo $row->kepalakiri2 ?></p>
                    </td>
                </tr>
                <tr>
                    <td height="23" colspan="3" style="border-left: 1px solid black;border-right: 1px solid black; text-align: center;text-decoration: underline;"><?php echo $row->namakiri2 ?></td>
                    <td colspan="3" style="border-right: 1px solid black; text-align: center;text-decoration: underline;"><?php echo $row->namakiri2 ?></td>
                </tr>
                <tr>
                    <td height="23" colspan="3" style="border-bottom: 1px solid black; border-left: 1px solid black;border-right: 1px solid black;text-align: center;"><?php echo $row->nipkiri2 ?></td>
                    <td colspan="3" style="border-bottom: 1px solid black;border-right: 1px solid black;text-align: center;"><?php echo $row->nipkiri2 ?></td>
                </tr>
                <!-- baris ketiga -->
                <tr>
                    <td width="109" style="border-top: 1px solid black; border-left: 1px solid black">Tiba di</td>
                    <td width="10" style="border-top: 1px solid black">:</td>
                    <td width="90" style="border-top: 1px solid black; border-right: 1px solid black"><?php echo $row->tibadi3 ?></td>
                    <td width="73" style="border-top: 1px solid black">Berangkat dari</td>
                    <td width="10" style="border-top: 1px solid black">:</td>
                    <td width="137" style="border-right: 1px solid black; border-top: 1px solid black"><?php echo $row->dari3 ?></td>
                </tr>
                <tr>
                    <td height="23" style="border-left: 1px solid black">Pada Tanggal</td>
                    <td>:</td>
                    <td style="border-right: 1px solid black"><?php echo $row->tgl_kiri3 ?>
                    </td>
                    <td>Ke</td>
                    <td>:</td>
                    <td style="border-right: 1px solid black"><?php echo $row->ke3 ?></td>
                </tr>
                <tr>
                    <td height="23" style="border-left: 1px solid black">&nbsp;</td>
                    <td>&nbsp;</td>
                    ...
                    <td>Pada Tanggal</td>
                    <td>:</td>
                    <td style="border-right: 1px solid black"><?php echo $row->tgl_kanan3 ?>
                    </td>
                </tr>
                <tr>
                    <td height="50" colspan="3" style="border-left: 1px solid black;border-right: 1px solid black; vertical-align: top;text-align: center;"><?php echo $row->kepalakiri3 ?></td>
                    <td colspan="3" style="vertical-align: top;border-right: 1px solid black;text-align: center;">
                        <p><?php echo $row->kepalakiri3 ?></p>
                    </td>
                </tr>
                <tr>
                    <td height="16" colspan="3" style="border-left: 1px solid black;border-right: 1px solid black;text-align: center;"><?php echo $row->namakiri3 ?></td>
                    <td colspan="3" style="border-right: 1px solid black; text-align: center"><?php echo $row->namakiri3 ?></td>
                </tr>
                <tr>
                    <td height="17" colspan="3" style="border-bottom: 1px solid black; border-left: 1px solid black; border-right: 1px solid black;text-align: center;"><?php echo $row->nipkiri3 ?></td>
                    <td colspan="3" style="border-bottom: 1px solid black;border-right: 1px solid black;text-align: center;"><?php echo $row->nipkiri3 ?></td>
                </tr>
                <tr>
